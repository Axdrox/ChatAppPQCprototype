...
import 'react-native-get-random-values'; //crypto.getRandomValues for React Native useful to polyfill for libraries like uuid that depend on it.
/*****************************************************************************************************************************/
const nttZetas = [
...
KeyGen768 = function() {
    ...
    crypto.getRandomValues(rnd); // react-native-get-random-values library method that lets you get cryptographically strong random values. 
...
Encrypt768 = function(pk) {
    ...
    crypto.getRandomValues(m); // react-native-get-random-values library method that lets you get cryptographically strong random values. 
...
/* COMENTO ESTA SECCION PARA NO CORRER LOS TESTS PORQUE "the native React runtime does not include the Node standard library module "fs"."
// test run function
Test768 = function(){
